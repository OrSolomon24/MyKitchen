...
const FEATURES = [
  {
    icon: FaBookOpen,
    title: 'ארכיון אישי',
    text: 'כל המתכונים של המשפחה שמורים במקום אחד, נגישים מכל מכשיר.',
  },
  {
    icon: FaLink,
      ...
      <section className="mx-auto grid max-w-[1200px] items-center gap-10 px-5 pb-14 pt-8 md:grid-cols-[1.05fr_0.95fr] md:px-6 md:pb-20 md:pt-14">
        <div>
          ...
          <p className="mb-7 max-w-[52ch] text-md leading-relaxed text-text-muted">
            כל האוצרות הקולינריים שלנו במקום אחד — מתכונים מסורתיים שעברו במשפחה מדור
            לדור, המצאות מטבח מקוריות, וגילויים חדשים שאהבנו.
          </p>
